        ...
        <div className="max-w-[1200px] mx-auto">
            ...
            <div className="flex-1">
              ...
              <div className="flex flex-col gap-4">
                <table className="w-full border-collapse text-[15px]">
                  <tbody>
                    <tr className="border border-gray-300">
                      <td className="px-4 py-4 font-bold text-black w-[160px] align-top">&ldquo;Neuro&rdquo;</td>
                ...
                <table className="w-full border-collapse text-[15px]">
                  <tbody>
                    <tr className="border border-gray-300">
                      <td className="px-4 py-4 font-bold text-black w-[160px] align-top">&ldquo;Linguistic&rdquo;</td>
                      <td className="px-4 py-4 text-gray-700 border-l border-gray-300">
                ...
                <table className="w-full border-collapse text-[15px]">
                  <tbody>
                    <tr className="border border-gray-300">
                      <td className="px-4 py-4 font-bold text-black w-[160px] align-top">&ldquo;Programming&rdquo;</td>
                      <td className="px-4 py-4 text-gray-700 border-l border-gray-300">
          ...
          <div className="mb-14">
            ...
            <p className="text-gray-700 text-[15px] leading-relaxed">
              ...
              phrase (&ldquo;I&apos;ll never get this right&rdquo;), then{' '}
              <span className="italic">reframe it to</span>{' '}
              (&ldquo;I&apos;m still learning, and each step brings me closer&rdquo;).
            </p>
          </div>
