        ...
        <div className="flex flex-col lg:flex-row gap-10 lg:gap-14">
          <div className="w-full lg:w-[46%]">
            <div className="rounded-2xl overflow-hidden border border-gray-100 shadow-md bg-stone-50" style={{ aspectRatio: "4/3" }}>
              <img src="/assets/careox-journal-front.png" alt="Vintage Leather Wellness Journal" className="w-full h-full object-cover" />
            </div>
          </div>
          <div className="w-full lg:flex-1 flex flex-col">
            <div className="flex items-center gap-1.5 mb-3">
              {[1,2,3,4,5].map((s) => <StarIcon key={s} filled />)}
              <span className="text-xs text-gray-400 ml-1">(25 reviews)</span>
            </div>
            <h1 className="text-2xl sm:text-[1.75rem] font-semibold text-gray-900 leading-snug mb-3">Vintage Leather Wellness Journal | 380 Pages</h1>
            <div className="flex items-baseline gap-3 mb-4">
              <span className="text-3xl font-bold text-gray-900">$99.00</span>
            </div>
            <p className="text-sm text-gray-500 leading-relaxed mb-3">
              The Heal Conscious, mental healthcare in a box integrated 380 pages vintage leather journal.
            </p>
            ...
            <button onClick={() => router.push("/store")} className="w-full h-11 rounded-lg border-2 border-gray-900 text-sm font-semibold text-gray-900 hover:bg-gray-50 mb-4">BUY IT NOW</button>
          ...
          <div className="flex border-b border-gray-200">
            {["description", "reviews"].map((tab) => (
              <button key={tab} onClick={() => setActiveTab(tab)}
                ...
                {tab === "reviews" ? "Reviews (25)" : "Description"}
              </button>
            ))}
          </div>
          <div className="py-10 text-gray-600 leading-relaxed text-[15px]">
            {activeTab === "description" ? (
              <div className="space-y-5 max-w-3xl">
                <p>The Heal Conscious Careox integrated 380-Page Leather Mental Health Journal combines elegance with ample space for your reflections.</p>
                <ul className="space-y-3">
                  {[["Pages and Dimensions", '6.5" x 7.5" x 2.5" — 380 pages'], ["Perfect Page Size", "A5 compact yet spacious"], ["Premium Vintage Leather Cover", "Durable, stylish, built to last"]].map(([title, desc]) => (
      ...
      <section className="w-full border-t border-gray-100 mt-2 py-12">
        <div className="max-w-6xl mx-auto px-4 sm:px-8">
          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 gap-6">
            ...
            <Link href="/product-careox-calendar" className="group cursor-pointer">
              <div className="rounded-xl overflow-hidden bg-gray-50 border border-gray-100 mb-3" style={{ aspectRatio: "4/3" }}>
                <img src="/assets/Careox-Integrated-Printable-Page-Heal-Conscious-1536x1113.png" alt="Printable Calendar" className="w-full h-full object-cover group-hover:scale-105 transition-transform duration-300" />
              </div>
              <p className="text-sm text-gray-700 text-center mb-1">Careox Program Printable Calendar</p>
              <p className="text-sm font-semibold text-gray-900 text-center">$15.00</p>
            </Link>
          </div>
        </div>
      </section>
