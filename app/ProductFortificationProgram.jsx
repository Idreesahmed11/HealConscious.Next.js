"use client";
// components/products/CareoxProgramProduct.jsx
// Product 1: Careox 4 Week Mental Health Fortification Program
...
export default function CareoxProgramProduct() {
          ...
          <div className="py-10 text-gray-600 leading-relaxed text-[15px]">
            {activeTab === "description" ? (
              <div className="space-y-5 max-w-3xl">
                ...
                <p>Careox is a 28-day mental healthcare guide designed to help you release buried pain, ease daily stress, and break free from social pressures. Curated by psychologists and expert coaches, it blends reflection, healing practices, and practical exercises.</p>
                <div>
      ...
      <section className="w-full border-t border-gray-100 mt-2 py-12">
        <div className="max-w-6xl mx-auto px-4 sm:px-8">
          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 gap-6">
            <Link href="/product/careox-program-printable-calendar" className="group cursor-pointer">
            ...
            <Link href="/product/journal-mental-healthcare-leather-journal" className="group cursor-pointer">
              <div className="rounded-xl overflow-hidden bg-gray-50 border border-gray-100 mb-3" style={{ aspectRatio: "4/3" }}>
