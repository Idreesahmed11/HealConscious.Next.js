...
const Trauma = '/assets/Somatic-Healing-for-Trauma-Stress-380x380.webp';
    ...
    <div className="w-full font-sans">
          ...
          <div className="flex flex-col lg:flex-row gap-10 items-start">
            <div className="flex-1">
              ...
              <p className="text-gray-700 text-[15px] leading-relaxed mb-4">
                ...
                <strong>&ldquo;fight and flight response&rdquo;</strong> that couldn&apos;t fully reveal itself during the original event.
              </p>
              <p className="text-gray-700 text-[15px] leading-relaxed mb-4">
          ...
          <div className="flex flex-col lg:flex-row gap-12">
            ...
            <div className="flex-1">
              ...
              <div className="space-y-4 text-[15px] text-gray-700">
                ...
                <p>
                  <span className="font-bold">» Non-Verbal Release:</span> Focused exercises utilize small, intuitive movements and specialized <strong>breathwork</strong> to facilitate the release of the &ldquo;frozen&rdquo; survival energy, acknowledging the body&apos;s wisdom.
                </p>
                <p>
      ...
      <div className="bg-white py-12">
        <div className="max-w-[1200px] mx-auto px-6">
          ...
          <p className="text-gray-700 text-[15px] leading-relaxed mb-3">
            Unlike traditional &ldquo;top-down&rdquo; talk therapy which starts with thoughts, Somatic Experiencing uses a <strong>&ldquo;body-first&rdquo; approach</strong>.
          </p>
          <p className="text-gray-700 text-[15px] leading-relaxed mb-5">
          ...
          <div className="space-y-3 text-[15px] text-gray-700">
            <p>
              <span className="font-bold">» Regulating the Nervous System</span>: SE helps calm subcortical brain networks that keep the &ldquo;threat alarm&rdquo; stuck in one position, reducing chronic stress and dysregulation.
            </p>
            <p>
      ...
      <div className="bg-white py-16">
        <div className="max-w-[1200px] mx-auto px-6 text-center">
          ...
          <button className="bg-[#4db8c0] hover:bg-[#3aa4ac] text-white text-[13px] font-bold tracking-widest uppercase px-10 py-3 transition-colors duration-200">
