"use client";
// components/products/LeatherJournalProduct.jsx
// Product 3: Vintage Leather Wellness Journal | 380 Pages
      ...
      <div ref={modalRef} className="bg-white w-full max-w-sm rounded-lg shadow-2xl overflow-hidden flex flex-col" style={{ maxHeight: "90vh" }}>
        ...
        <div className="overflow-y-auto flex-1 px-5 py-5">
          ...
          <div className="flex gap-3 mb-4">
            <input type="text" placeholder="MM/YY" value={expiry} onChange={(e) => setExpiry(formatExpiry(e.target.value))} className="flex-1 border border-gray-300 rounded px-3 py-3 text-sm outline-none text-gray-800 placeholder-gray-400" />
            <input type="text" placeholder="CVV" value={cvv} onChange={(e) => setCvv(e.target.value.replace(/\D/g, "").slice(0, 4))} className="flex-1 border border-gray-300 rounded px-3 py-3 text-sm outline-none text-gray-800 placeholder-gray-400" />
          </div>
          <input type="text" placeholder="Cardholder name" value={name} onChange={(e) => setName(e.target.value)} className="w-full border border-gray-300 rounded px-3 py-3 text-sm outline-none text-gray-800 placeholder-gray-400 mb-6" />
...
export default function LeatherJournalProduct() {
          ...
          <div className="py-10 text-gray-600 leading-relaxed text-[15px]">
            {activeTab === "description" ? (
              <div className="space-y-5 max-w-3xl">
                <p>The Heal Conscious Careox integrated 380-Page Leather Mental Health Journal combines the elegance of a vintage leather notebook with ample space to support your longwinded ramblings and emotional outpour to unwind yourself for retrospective inspection.</p>
                <p>The journal is designed on psychological principles, and includes features to help you improve your daily routine and cultivate better habits.</p>
                <div>
                  <h4 className="font-bold mb-4 text-gray-900 text-base">Key Features:</h4>
                  <ul className="space-y-3">
                    {[
                      ['Pages and Dimensions', '6.5" width x 7.5" height x 2.5" depth and 380 pages. The journal offers enough space for a full year of reflections, mood tracking, and gratitude journaling.'],
      ...
      <section className="w-full border-t border-gray-100 mt-2 py-12">
        <div className="max-w-6xl mx-auto px-4 sm:px-8">
          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 gap-6">
            <Link href="/product/careox-4-week-mental-health-fortification-program" className="group cursor-pointer">
