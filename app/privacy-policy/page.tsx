    ...
    <div className="w-full min-h-screen bg-white font-sans">
      ...
      <section className="w-full bg-white py-12 px-6 md:px-16 lg:px-24">
        <div className="max-w-5xl mx-auto text-gray-800">
          ...
          <p className="mb-3">
            <span className="font-semibold">1.1 Welcome:</span> Welcome to Heal Conscious (&ldquo;Company&rdquo;, &ldquo;we&rdquo;, &ldquo;us&rdquo;, or &ldquo;our&rdquo;). This Privacy Policy explains how we collect, use, disclose, and protect your information when you use our website <span className="font-semibold">healconscious.com</span> and mobile application <span className="font-semibold">Careox Connect</span> (collectively, the &ldquo;Services&rdquo;).
          </p>
          <p className="mb-6">
            <span className="font-semibold">1.2 Scope:</span> This Privacy Policy applies to all visitors, users, and affiliates (&ldquo;you&rdquo; or &ldquo;your&rdquo;), including users of our online store, community sections, forums, and affiliate program.
          </p>
          ...
          <p className="mb-3">
            <span className="font-semibold">4.1 Service Providers:</span> We may share your information with trusted third-party service providers, such as payment processors, shipping partners, and email service providers.
          </p>
          <p className="mb-3">
          ...
          <p className="mb-3">
            <span className="font-semibold">4.3 Legal Requirements:</span> We may disclose information when required by law or in response to valid legal requests.
          </p>
          <p className="mb-3">
            <span className="font-semibold">4.4 Affiliates:</span> Information may be shared with affiliates to administer and ensure compliance with the affiliate program.
          </p>
