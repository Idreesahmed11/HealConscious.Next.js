...
export default function PrintableCalendarProduct() {
        ...
        <div className="flex flex-col lg:flex-row gap-10 lg:gap-14">
          ...
          <div className="w-full lg:flex-1 flex flex-col">
            ...
            <p className="text-sm text-gray-500 leading-relaxed mb-4">
              A beautiful printable calendar to track your Careox program journey day by day. Stay organized and motivated with this thoughtfully designed tool.
            </p>
          ...
          <div className="py-10 text-gray-600 leading-relaxed text-[15px]">
            {activeTab === "description" ? (
              <div className="space-y-5 max-w-3xl">
                <p>The Careox Program Calendar is your go-to tool for building structure and balance in daily life. More than just a calendar, it's a habit tracker, reminder system, and productivity planner all in one.</p>
                <p>This printable calendar can be easily stuck on your kitchen, living space, or bedroom wall to keep track of your program activities and gently remind you of important habits, tasks, and wellness routines.</p>
                <div>
