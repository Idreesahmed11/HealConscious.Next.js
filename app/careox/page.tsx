...
const LogoSymbol = '/assets/Careox-Connect-Mobile-App-Screens-300x275.png';
const HeroDevicesImage = '/assets/healconscious-carebox-home-banner-row-1-1-2-300x275-DGHTNQbA.webp';
const ZombieBackgroundImage = '/assets/Emotional-Intelligence-EQ-Management-with-Careox-300x225.webp';
const firstImg = '/assets/first-wave-300x164.png';
const secondImg = '/assets/second-wave-300x168.png';
const thirdImg = '/assets/third-wave-300x166.png';
const futureImg = '/assets/Heal-Conscious-Future-Culture-Shock.jpg';
const img1 = '/assets/image_one-1-411x230.webp';
const img2 = '/assets/Heal-Conscious-Careox-Connect-Tablet-411x213.png';
...
const afterWeekImg = '/assets/image_three-237x300.webp';
const emotionalFreedomImg = '/assets/emotional-freedom-300x223.png';
...
const eqManagementImg = '/assets/Emotional-Intelligence-EQ-Management-with-Careox-300x225 (1).webp';
const somaticImg = '/assets/Somatic-Healing-for-Trauma-Stress-300x225.webp';
const yogaImg = '/assets/yoga-300x225.webp';
const sportsPsychologyImg = '/assets/Sports-Psychology-300x225.webp';
const spiritualPsychologyImg = '/assets/Spiritual-Psychology-300x225.webp';
const spiritualTappingImg = '/assets/Careox_-Spiritual-Tapping-EFT-for-Stress-Relief-Inner-Peace-300x225.webp';
const japanesePsychologyImg = '/assets/Careox_The-Wisdom-of-Japanese-Life-Psychology-300x225.webp';
const cbtToolsImg = '/assets/Practical-CBT-Tools-for-Anxiety-Stress-with-Careox-300x225.webp';
